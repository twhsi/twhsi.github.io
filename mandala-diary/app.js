...
function applySiteMeta() {
  const siteTitle = state.data.siteTitle || state.data.sourceVault || "Obsidian Publish Clone";
  document.title = siteTitle;
  if (vaultTitleEl) vaultTitleEl.textContent = siteTitle;
  if (readerLabelEl) readerLabelEl.textContent = `${siteTitle} Reader`;
}
